...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
    ...
    private static String SQLgetListSequenceEcriture;
    public void setSQLgetListSequenceEcriture(String SQLgetListSequenceEcriture) {
        this.SQLgetListSequenceEcriture = SQLgetListSequenceEcriture;
    }
    ...
    public List<SequenceEcritureComptable> getListSequenceEcritureComptable() {
        ...
        List<SequenceEcritureComptable> list = vJdbcTemplate.query(SQLgetListSequenceEcriture, sequenceRM);
        return list;
    }
    ...
    public void deleteSequenceEcritureComptable(SequenceEcritureComptable sequence) {
        ...
        vSqlParams.addValue("journal_code", sequence.getCodeJournal());
        vSqlParams.addValue("annee", sequence.getAnnee());
        System.out.println(sequence.getCodeJournal() + " --- " + sequence.getAnnee());
